...
const NAV_ITEMS = [
  {
    ...
    roles: ['admin', 'lider', 'cajero', 'hostess'],
  },
  {
    id: 'analytics',
    path: '/analiticas',
  ...
  },
  {
    ...
    roles: ['admin', 'lider', 'cajero', 'hostess', 'mozo'],
  },
  {
    id: 'tables',
    path: '/mesas',
    ...
    roles: ['admin', 'lider', 'hostess', 'mozo'],
  },
  {
    id: 'clients',
    path: '/clientes',
  ...
  },
  {
    ...
    roles: ['jefe_cocina', 'mozo', 'lider', 'admin'],
  },
  {
    id: 'history',
    path: '/historial',
